        ...
        <div class="bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl border border-slate-700">
            <div class="relative overflow-hidden">
                ...
                <div class="relative p-8 text-center">
                    ...
                    <h2 class="text-4xl font-bold text-white mb-2">Welcome to the Future of Social Media</h2>
                    <p class="text-slate-300 text-lg">We've just added 45+ revolutionary features that put you in control</p>
                </div>
            </div>
            ...
            <div class="p-8 overflow-y-auto max-h-[calc(90vh-300px)]">
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-xl p-6">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Your Wellbeing Matters</h3>
                    ...
                    <div class="bg-gradient-to-br from-blue-500/10 to-teal-500/10 border border-blue-500/30 rounded-xl p-6">
                        <div class="text-4xl mb-3">🤝</div>
                        <h3 class="text-xl font-bold text-white mb-2">Real Connections</h3>
                        <ul class="space-y-2 text-sm text-slate-300">
                    ...
                    <div class="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/30 rounded-xl p-6">
                        <div class="text-4xl mb-3">🔒</div>
                        <h3 class="text-xl font-bold text-white mb-2">You're In Control</h3>
                        <ul class="space-y-2 text-sm text-slate-300">
                    ...
                    <div class="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-xl p-6">
                        <div class="text-4xl mb-3">💰</div>
                        <h3 class="text-xl font-bold text-white mb-2">Creator Empowerment</h3>
                        <ul class="space-y-2 text-sm text-slate-300">
                    ...
                    <div class="bg-gradient-to-br from-green-500/10 to-teal-500/10 border border-green-500/30 rounded-xl p-6">
                    ...
                    <div class="bg-gradient-to-br from-red-500/10 to-orange-500/10 border border-red-500/30 rounded-xl p-6">
                        <div class="text-4xl mb-3">😈</div>
            ...
            <div class="p-6 border-t border-slate-700 flex justify-between items-center bg-slate-900/50">
                ...
                <button onclick="closeOnboarding()" class="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-lg transition-all transform hover:scale-105">
                    Let's Go! 🚀
                </button>
            </div>
        </div>
